...
std::string Lx200::getComandType(std::string comand){
    ...
    if (std::regex_search(comand, sm, this->regex)) {
        return sm[1];
    }else{
        return "unknown";
    }
